...
namespace OnlineShopping.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private dbMyOnilineShoppingEntities1 _DBEntity;
        public GenericRepository(dbMyOnilineShoppingEntities1 DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public Tbl_Entity GetFirstorDefualt(int RecordId)
        {
            throw new NotImplementedException();
        }
        ...
        public Tbl_Entity GetFirstorDefualtByParameter(Expression<Func<Tbl_Entity, bool>> WherePredict)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<Tbl_Entity> GetResualtBySqlProcedure(string query, params object[] Parameters)
        {
            throw new NotImplementedException();
        }
    }
